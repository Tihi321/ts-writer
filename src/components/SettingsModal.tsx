                  ...
                  <Show when={!googleAuth.signedIn}>
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                          <h4 class="text-sm font-medium text-blue-900">Connect to Google Drive</h4>
                    ...
                    <div class="space-y-4">
                      <label class="flex items-center justify-between">
                        ...
                        <button
                          ...
                          class={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            settingsStore.settings.autoSignIn ? "bg-blue-600" : "bg-gray-200"
                          }`}
                        >
                          <span
                      ...
                      <label class="flex items-center justify-between">
                        ...
                        <button
                          ...
                          class={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            settingsStore.settings.autoSyncEnabled ? "bg-blue-600" : "bg-gray-200"
                          }`}
                        >
                          <span
                            class={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                ...
                <div class="space-y-4 border-t border-gray-200 pt-6">
                  ...
                  <label class="flex items-center justify-between">
                    ...
                    <button
                      ...
                      class={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        uiStore.isZenMode() ? "bg-purple-600" : "bg-gray-200"
                      }`}
                    >
                      <span
                        class={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                ...
                <div class="space-y-4 border-t border-gray-200 pt-6">
                  ...
                  <div class="space-y-3">
                    ...
                    <button
                      ...
                      disabled={isClearing()}
                      class="w-full bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 text-white font-medium py-2 px-4 rounded-md transition-colors duration-200"
                    >
